...
void oled_show(void)
{
		...
		{
			OLED_ShowNumber(00,0,Bluetooth_Velocity,3,12);
			OLED_ShowNumber(45,0,Flag_Direction,3,12);  //PS2的数据	
		  OLED_ShowString(00,10,"RX");
			OLED_ShowNumber(30,10, Raspberry_Angle,3,12);  //PS2的数据		
		}			
		else if(Flag_Way==5)//turn back test 20190630
		{
			OLED_ShowString(00,0,"Angle");
			OLED_ShowNumber(45,0,Angle*(180/3.1415),3,12); 
		  OLED_ShowString(00,10,"Vel");
			OLED_ShowNumber(30,10, Velocity,3,12); 
		}			
		...
		if(Encoder_Right<0)	  OLED_ShowString(80,30,"-"),
		 ...
		 if(Voltage%100<10) 	OLED_ShowNumber(72,40,0,2,12);
													...
													else if(Flag_Way==4)				  OLED_ShowString(40,50,"PI");
													else if(Flag_Way==5)				  OLED_ShowString(40,50,"turn back");//turn back 20190630
...
void oled_show_once(void)
{
   ...
   OLED_ShowString(0,10,"TO Select Mode");
	...
	if(Flag_Way==4)         OLED_ShowString(50,30,"PI");
	if(Flag_Way==5)         OLED_ShowString(50,30,"TBK");//turn back 20190630
