...
mySerial.write(35);//ASCLL #井号
  ...
  mySerial.write(35);//ASCLL #井号
   ...
   /////////SEND////
void tcpsend_procceed(float signalsign,char test[16] , float data, int i, int j, int m)
{
...
void loop() 
{
  ...
  //transmit
       tcpsend_procceed(11,test , real_gesture.up_down, 1, 0, 2);
       tcpsend_procceed(12,test , real_gesture.left_right, 1, 0, 2);
       tcpsend_procceed(13,test , angle, 3, 2, 5);
