...
{
	    if(Flag_Way==2||Flag_Way==3)//Ñ²ÏßÄ£Ê½ÏÂ£¬Ö»ÔÊĞíµç»úÕı×ª
			{
  ...
  float LY,RX;
	...
	else if(Flag_Way==4)//Ê÷İ®ÅÉ¿ØÖÆ
	{
		switch(Flag_Direction)
		{
			...
			case 2:Velocity=0,Angle=Raspberry_Angle;break; //¶æ»úÇ¿you
			case 3:Velocity=0,Angle=Raspberry_Angle;break;//¶æ»úÇ¿zuo×ª
			case 4:Velocity=Bluetooth_Velocity,Angle=0;break;//Ö±ĞĞ
			case 5:Velocity=Bluetooth_Velocity,Angle=Raspberry_Angle;break;//Ç°ÓÒ
			case 6:Velocity=Bluetooth_Velocity,Angle=-Raspberry_Angle;break;//Ç°×ó
			case 7:Velocity=-Bluetooth_Velocity,Angle=0;break;//µ¹³µ
			case 8:Velocity=-Bluetooth_Velocity,Angle=Raspberry_Angle;break;//ºóyou
			case 9:Velocity=-Bluetooth_Velocity,Angle=-Raspberry_Angle;break;//ºózuo
		}
		/*if(Flag_Direction==0) Velocity=0,Angle=0;   //Í£Ö¹
		else if(Flag_Direction==1) Velocity=Bluetooth_Velocity,Angle=0;  //Ç°½ø
		else if(Flag_Direction==2) Velocity=Bluetooth_Velocity,Angle=PI/5;  //ÓÒÇ°
