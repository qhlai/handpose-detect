...
extern int turnback ;//turn back 20190630
...
extern u16 ADV[128];
extern u8 CCD_Zhongzhi,CCD_Yuzhi,PID_Send,Flash_Send,Bluetooth_Velocity,Raspberry_Angle,APP_RX;     //线性CCD相关
//extern float Raspberry_Angle;//树莓派控制角度
