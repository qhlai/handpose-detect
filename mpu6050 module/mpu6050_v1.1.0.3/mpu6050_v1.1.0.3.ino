...
void Kalman_Filter(double angle_m, double gyro_m)
{
 ...
 /////////SEND////
void tcpsend_all(int num,char test[100] , float data1, float data2, float data3,float data4,float data5,float data6)
{
...
mySerial.write(35);//ASCLL #井号
  ...
  mySerial.write(35);//ASCLL #井号
   ...
   /////////SEND////
void tcpsend_procceed(int num,char test[100] , float data1, float data2, float data3)
{
